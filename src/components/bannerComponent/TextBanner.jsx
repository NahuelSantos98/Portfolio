    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center">
                ...
                <a href="/CV-Nahuel Santos.pdf" download="CV Nahuel Martin Santos" className="w-[10rem] text-white border border-white rounded-lg p-2 my-4 hover:bg-gray-700 text-white hover:scale-105 active:scale-none mb-2 text-center transition-all duration-300 ease-in-out">
                    Descargar CV
                </a>
            </div>
        </div>
