        ...
        <div className="flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center">
                <div className="flex items-center">
                    <p className="text-white text-left">Hola, como estas?</p>
                </div>
                ...
                <a href={`${import.meta.env.BASE_URL}cv-nahuel-santos.pdf`} download="CV Nahuel Martin Santos" className="w-[10rem] text-white border border-white rounded-lg p-2 my-4 hover:bg-gray-700 text-white hover:scale-105 active:scale-none mb-2 text-center transition-all duration-300 ease-in-out">
                    Descargar CV
                </a>
            </div>
        </div>
